...
const DEFAULT_ADVANTAGES: {
...
}[] = [
  {
    ...
    description:
      "Житловий масив однаково зручний для родин з дітьми, людей поважного віку та тих, хто працює вдома. Кожен почувається тут на своєму місці",
  },
  {
  ...
  },
  {
    ...
    description:
      "Із самого початку житловий масив проєктувався як середовище для життя, а не як набір будівель. Тут усе зроблено з розумом — і на плані, і в реальності",
  },
  {
  ...
  return (
    <section className={s.section}>
      <Container className={s.container}>
        <h2>Переваги житлового масиву</h2>
