...
const AboutSection = () => {
  ...
  const cardText =
    about.card_text ||
    "Житловий масив виглядає спокійно й доречно, без спроб виділитися формою чи кольором. Форми зрозумілі, фасади лаконічні, між будинками достатньо простору та світла";
